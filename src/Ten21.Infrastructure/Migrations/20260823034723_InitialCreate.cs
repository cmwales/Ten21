...
namespace Ten21.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalValuesJson = table.Column<string>(type: "text", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_document_attachments_TenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tenant_memberships_UserId_TenantId_RoleId",
                table: "tenant_memberships",
            ...
            // Row-Level Security policies for US-01, folded in per the instructions at the
            // top of sql/rls-policies.sql -- see that file for the full reasoning (why
            // tenant_memberships is deliberately excluded, why current_setting uses
            // missing_ok=true, etc). Kept as one migrationBuilder.Sql(...) call per
            // statement rather than a single giant string so a partial failure is easier to
            // pinpoint against the source file.
            //
            // NOTE: the column is quoted "TenantId", not unquoted tenant_id like the
            // original sql/rls-policies.sql draft had it -- no entity configuration ever
            // snake_cased individual COLUMN names (only table names got that treatment), so
            // Postgres's real column is the case-preserved "TenantId". Unquoted tenant_id
            // folds to lowercase and doesn't exist, which fails the migration outright rather
            // than silently matching nothing -- caught by RlsIsolationTests.
            ...
            migrationBuilder.Sql("ALTER TABLE document_attachments ENABLE ROW LEVEL SECURITY;");
            migrationBuilder.Sql("ALTER TABLE document_attachments FORCE ROW LEVEL SECURITY;");
            migrationBuilder.Sql("""
        ...
        {
            // Mirror image of the RLS policies added at the end of Up() -- policies/RLS
            // flags must be dropped before the tables themselves so this reverses cleanly.
            migrationBuilder.Sql("DROP POLICY IF EXISTS tenant_isolation_properties ON properties;");
            ...
            migrationBuilder.Sql("ALTER TABLE document_attachments DISABLE ROW LEVEL SECURITY;");
